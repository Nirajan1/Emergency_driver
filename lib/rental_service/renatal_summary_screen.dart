            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontFamily: "Poppinsm", color: isDarkMode(context) ? Colors.black : const Color(0xff333333), fontSize: 16),
                ),
              ],
            )),
        const Divider(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontFamily: "Poppinsm", color: Colors.red, fontSize: 16),
                ),
              ],
            )),
        const Divider(
